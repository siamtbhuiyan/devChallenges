...
const App = () => {
  return (
    <div className="container mx-auto py-14">
      <h1 className="font-poppins text-2xl font-medium text-gray-900">
        Buttons
      </h1>
      ...
      <div className="grid grid-cols-2 py-6">
        <Button
          title="<Button startIcon=AddShoppingCart />"
          color="primary"
          startIcon="AddShoppingCart"
        />
        <Button
          title="<Button endIcon=AddShoppingCart />"
          color="primary"
      ...
      <p className="pt-12 text-gray-400">
        created by{" "}
        <a
          href="https://devchallenges.io/portfolio/siamtbhuiyan"
          className="font-bold"
        >
          @siamtbhuiyan
        </a>{" "}
