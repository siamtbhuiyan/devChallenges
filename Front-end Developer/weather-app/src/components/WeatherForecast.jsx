const WeatherForecast = ({ currentForecast,  isFahrenheit, handleCelChange, handleFarChange }) => {
  return (
    <div className="pb-20">
        <div className="flex justify-end mx-3 xs:mx-12 xl:mx-24 my-10">
        ...
        <div className="forecasts">
            {currentForecast.map((f, index) => <div key={index} className={index === 4 ? "mx-3 md:mx-0 forecast" : "mx-3 md:mx-0 md:mr-3 lg:mr-6 forecast"}>
