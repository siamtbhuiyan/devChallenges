    ...
    return (
      <div>
          ...
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Agency Homepage</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with HTML and CSS to create a responsive page . The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. </div>
                  <div className="flex">
          ...
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">My Gallery</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with HTML and CSS to create a responsive page . The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. </div>
                  <div className="flex">
    ...
    return (
      <div>
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Button Components</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with React a web app. The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. Lorem ipsum dolor sit, amet consectetur</div>
                  <div className="flex">
          ...
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Quote Generator</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with React a web app. The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. Lorem ipsum dolor sit, amet consectetur</div>
                  <div className="flex">
          ...
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Todo App</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with React a web app. The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. Lorem ipsum dolor sit, amet consectetur</div>
                  <div className="flex">
    ...
    return (
      <div>
        <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Input Components</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with React a web app. The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. Lorem ipsum dolor sit, amet consectetur</div>
                  <div className="flex">
          ...
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Windbnb</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with Vue a web app. The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. Lorem ipsum dolor sit, amet consectetur</div>
                  <div className="flex">
          ...
          <div className="project">
              ...
              <div className="p-details">
                  <div className="font-medium text-2xl text-gray-800">Country Quiz</div>
                  <div className="font-medium text-gray-500 py-4">In this project, I work with Vue a web app. The design is from devchallenge.io. Donec aliquam est dui, vel vestibulum diam sollicitudin id. Quisque feugiat malesuada molestie. Lorem ipsum dolor sit, amet consectetur</div>
                  <div className="flex">
